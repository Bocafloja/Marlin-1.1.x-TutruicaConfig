...
#define STRING_CONFIG_H_AUTHOR "(Ricardo Najera, Tutruica AM8 config)" // Who made the changes.
...
//#define CUSTOM_MACHINE_NAME "Tutruica AM8"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 2560, 433 }
